    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card shadow-lg p-4 bg-white dark:bg-gray-900 rounded-lg">
                ...
                <!-- Add User Form -->
                <form class="space-y-5" action="<?php echo e(route('users.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-2">
                                    ...
                                    <select id="roles_id" name="roles_id"
                                        ...
                                        <?php $__currentLoopData = $getRole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($role->id); ?>" <?php echo e(old('roles_id') == $role->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <img id="imagePreview" src="<?php echo e(asset('assets/images/default-user.png')); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/users/add.blade.php ENDPATH**/ ?>