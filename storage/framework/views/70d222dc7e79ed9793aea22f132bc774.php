...
<nav aria-label="breadcrumb" class="mb-4 flex justify-start">
        <ol class="flex text-gray-500 font-semibold dark:text-white-dark dongrek-font">
            ...
            <li class="before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4">
                <a href="javascript:;" class="text-primary <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.add_new_purchase')); ?></a>
            </li>
        </ol>
    </nav>
    <h2 class="text-2xl font-semibold mb-4 dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.add_new_purchase')); ?></h2>
    <form action="<?php echo e(route('purchases.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>

        <!-- Purchase Details Container -->
        <div class="bg-white rounded shadow p-6 dark:bg-[#1b2e4b] mb-6">
            <h3 class="text-xl font-semibold mb-4 dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.purchase_details')); ?></h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Date: defaults to today's date but user can change -->
                <div>
                    <label class="block text-sm font-semibold dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.date')); ?> *</label>
                    <input type="date"
                           name="purchase_date"
                           id="purchase_date"
                ...
                <div>
                    <label class="block text-sm font-semibold dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.reference')); ?> *</label>
                    <input type="text"
                           name="reference"
                           id="reference"
                           class="form-input mt-1 block w-full"
                           placeholder="<?php echo e(__('text.auto_generate')); ?>"
                           value="<?php echo e(old('reference')); ?>">
                </div>

                <!-- Supplier -->
                <div>
                    <label class="block text-sm font-semibold dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.supplier')); ?> *</label>
                ...
                <!-- Status -->
                <div>
                    <label class="block text-sm font-semibold dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.Status')); ?></label>
                    <select name="status"
                            id="status"
                            class="form-select mt-1 block w-full dongrek-font">
                        <option value="Received"><?php echo e(__('text.received')); ?></option>
                        <option value="Pending"><?php echo e(__('text.pending')); ?></option>
                    </select>
                </div>

                <!-- Payment Method -->
                <div>
                    <label class="block text-sm font-semibold dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.payment_method')); ?></label>
                ...
                <div>
                <label class="block text-sm font-semibold dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.details')); ?></label>
                <textarea name="details"
                          id="details"
                          class="form-input mt-1 block w-full dongrek-font"
                          rows="3"
                          placeholder="<?php echo e(__('text.additional_details')); ?>"></textarea>
            </div>
            </div>
        </div>
    ...
    <div class="relative">
        ...
        <div class="relative mb-4 items-end dongrek-font">
            <input
                ...
                placeholder="<?php echo e(__('text.search_placeholder')); ?>"
            >
...
>
    <!-- Suggestions appear here -->
        ...
        <div class="bg-white rounded shadow p-6 dark:bg-[#1b2e4b]">
            <h3 class="text-xl font-semibold mb-4 dark:text-white dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.purchase_items')); ?></h3>
                ...
                <table class="w-full whitespace-nowrap shadow-sm table-auto">
                    <thead class="bg-blue-500 text-white">
                        <tr class="dongrek-font">
                            <th class="p-2 text-left <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.product_name')); ?></th>
                            <th class="p-2 text-left <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.qty')); ?></th>
                            <th class="p-2 text-left <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.discount')); ?></th>
                            <th class="p-2 text-left <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.units')); ?></th>
                            <th class="p-2 text-left <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.cost')); ?></th>
                            <th class="p-2 text-left <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.subtotal')); ?></th>
                            <th class="p-2 text-left <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.remove')); ?></th>
                        </tr>
                    </thead>
    ...
    <div>
        <span class="font-semibold mr-2 dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.subtotal')); ?>:</span>
        <span id="subtotal-amount">0.00</span>
    </div>
    <div>
        <span class="font-semibold mr-2 dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.discount')); ?>:</span>
        <span id="discount-amount">0.00</span>
    </div>
    <div>
        <span class="font-bold mr-2 dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.grand_total')); ?>:</span>
...
<div class="flex justify-end space-x-3">
    ...
    <button type="submit" class="btn-green px-6 py-2 rounded dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>"><?php echo e(__('text.create_purchase')); ?></button>
    <!-- Cancel button (link) -->
    <a href="<?php echo e(route('purchases.index')); ?>"
       class="btn-red px-6 py-2 rounded dongrek-font <?php echo e(app()->getLocale() == 'en' ? 'font-en' : 'font-kh'); ?>">
       <?php echo e(__('text.cancel')); ?>
            ...
            <tr class="border-b">
                ...
                <td class="p-2 text-center">
                    <button type="button" class="remove-btn text-red-500">
                        <img src="<?php echo e(asset('icons/delete.png')); ?>" alt="<?php echo e(__('text.remove')); ?>" class="w-6 h-6">
                    </button>
                </td>
            </tr>
        `;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/purchases/create.blade.php ENDPATH**/ ?>