...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('assets/images/sursdey_coffee_logo.png')); ?>" >
    ...
    <!-- Khmer Fonts -->
    <link href="<?php echo e(asset('css/khmer-fonts.css')); ?>" rel="stylesheet">

    <!-- Stylesheets -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/perfect-scrollbar.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/animate.css')); ?>" defer>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/highlight.min.css')); ?>" >
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/font-awesome.min.css')); ?>" >
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/file-upload-with-preview.min.css')); ?>" >
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/flatpickr.min.css')); ?>" >
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/checkbox-style.css')); ?>" >
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/switch-style.css')); ?>" >
    <!-- Scripts -->
...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[$store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ? 'dark' : '', $store.app.menu, $store.app.layout, $store.app.rtlClass]">
   ...
   <!-- Alpine.js Plugins -->
    ...
    <!-- ApexCharts -->
    <script defer src="<?php echo e(asset('assets/js/apexcharts.js')); ?>"></script>
...
<?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/layouts/master.blade.php ENDPATH**/ ?>