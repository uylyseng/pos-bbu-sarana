<?php $__env->startSection('content'); ?>
    ...
    <div class="min-h-screen flex bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full md:w-2/3 lg:w-2/3 bg-gray-200 dark:bg-gray-800 p-4 shadow-md rounded-[4px] relative h-screen flex flex-col bg-cover bg-center"
            style="background-image: url('<?php echo e(asset('assets/images/auth/coffee.jpg')); ?>');">
    ...
    <script>
        ...
        function showQRModal(payload) {
            ...
            const qrUrl = "<?php echo e(asset('assets/images/qrabas.jpg')); ?>"; // Adjust the path as needed
...
<?php echo $__env->make('layouts.poss', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/pos/customerscreen.blade.php ENDPATH**/ ?>