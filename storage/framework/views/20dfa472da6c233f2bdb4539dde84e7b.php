...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mt-6 p-4 bg-white rounded shadow dark:bg-[#1b2e4b]">
        <table class="w-full whitespace-nowrap shadow-sm">
            ...
            <tbody>
                <?php $__currentLoopData = $groupTables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupTable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                    <td class="px-4 py-2"><?php echo e($groupTable->id); ?></td>
                    <td class="px-4 py-2"><?php echo e($groupTable->name); ?></td>
                    <td class="px-4 py-2"><?php echo e($groupTable->descript); ?></td>
                    <td class="px-4 py-2 text-center">
                        <button class="text-blue-500 hover:text-blue-700 px-3 py-1 border border-blue-500 rounded mr-2" onclick="openEditModal(<?php echo e(json_encode($groupTable)); ?>)">
                            <i class="fa-solid fa-pen-to-square" style="color: blue;"></i> Edit
                        </button>
                        <button class="text-red-500 hover:text-red-700 px-3 py-1 border border-red-500 rounded" onclick="confirmDelete('<?php echo e(route('group_tables.destroy', $groupTable->id)); ?>')">
    ...
    <div >
        ...
        <?php if($groupTables->total() > 0): ?>
<div>
    <?php echo e($groupTables->links('layouts.pagination')); ?>
...
<script>
    function openCreateModal() {
        ...
        document.getElementById('groupTableForm').action = "<?php echo e(route('group_tables.store')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/group_tables/index.blade.php ENDPATH**/ ?>