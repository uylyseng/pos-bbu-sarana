...
<nav aria-label="breadcrumb" class="mb-4 flex justify-start">
        <ol class="flex text-gray-500 font-semibold dark:text-white-dark dongrek-font">
            ...
            <li class="before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 ">
                <a href="javascript:;" class="text-primary"><?php echo e(__('sales.sales_list')); ?></a>
            </li>
        </ol>
    </nav>
    <h2 class="text-xl font-bold mb-4 dongrek-font"><?php echo e(__('sales.sales_list')); ?></h2>

    <!-- Search & Per-Page Form -->
    <div class="mb-4 flex flex-col sm:flex-row justify-between items-center gap-4">
        <!-- Search Form -->
        <form method="GET" class="flex items-center gap-4 dongrek-font">
            <input type="text" name="search" placeholder="<?php echo e(__('sales.search_placeholder')); ?>"
        ...
        <table class="min-w-full text-sm text-left">
            <thead class="bg-gray-100 font-bold">
                <tr class=" dongrek-font">
                    <th class="px-4 py-3"><?php echo e(__('sales.date')); ?></th>
                    <th class="px-4 py-2"><?php echo e(__('sales.table')); ?></th>
                    <th class="px-4 py-2"><?php echo e(__('sales.status')); ?></th>
                    <th class="px-4 py-2"><?php echo e(__('sales.discount')); ?></th>
                    <th class="px-4 py-2"><?php echo e(__('sales.total')); ?></th>
                    <th class="px-4 py-2"><?php echo e(__('sales.payment_status')); ?></th>
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2"><?php echo e($sale->table_name ?? __('sales.na')); ?></td>
                    <td class="px-6 py-3 text-sm">
                                ...
                                <span class="status-badge <?php echo e($orderClass); ?>">
                                    <?php echo e(ucfirst($sale->order_status ?? __('sales.na'))); ?>
                    ...
                    <td class="px-6 py-3 text-sm">
                                ...
                                <span class="status-badge <?php echo e($paymentClass); ?>">
                                    <?php echo e(ucfirst($sale->payment_status ?? __('sales.na'))); ?>
                ...
                <tr><td colspan="8" class="px-4 py-3 text-center"><?php echo e(__('sales.no_sales_found')); ?></td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
    ...
    <div class="mt-6 flex flex-col sm:flex-row justify-between items-center">
        ...
        <?php else: ?>
            <p class="text-center text-gray-600 dark:text-gray-300"><?php echo e(__('sales.no_sales_available')); ?></p>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/sales/list.blade.php ENDPATH**/ ?>