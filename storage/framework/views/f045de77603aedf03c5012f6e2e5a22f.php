                ...
                <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                    <a href="index.html" class="main-logo flex shrink-0 items-center">
                        ...
                        <span
                            ...
                            <?php echo e(Auth::user()->store->name ?? config('app.name', 'សួស្តីកាហ្វេ នំខេកនិងម៉ាត')); ?>
                ...
                <div x-data="header"
                    ...
                    <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                        ...
                        <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                            ...
                            <li>
                                <a href="<?php echo e(route('changeLang', ['lang' => 'en'])); ?>" class="hover:text-primary"
                                    @click="$store.app.toggleLocale('en'), toggle()"
                                    :class="{'bg-primary/10 text-primary': $store.app.locale === 'en'}">
                                    <img src="<?php echo e(asset('assets/images/flags/EN.svg')); ?>" alt="English"
                                        class="h-5 w-5  object-cover">
                                    <span class="ltr:ml-3 rtl:mr-3">English</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('changeLang', ['lang' => 'km'])); ?>" class="hover:text-primary"
                                    @click="$store.app.toggleLocale('kh'), toggle()"
                                    :class="{'bg-primary/10 text-primary': $store.app.locale === 'kh'}">
                                    <img src="<?php echo e(asset('assets/images/flags/KH.svg')); ?>" alt="Khmer"
                                        class="h-5 w-5  object-cover">
                        ...
                        <a href="javascript:;" class="group relative" @click="toggle()">
                            <span class="relative inline-block">
                                ...
                                <img class="h-9 w-9 rounded-full object-cover saturate-100 group-hover:saturate-100"
                                    src="<?php echo e(Auth::user() && Auth::user()->profile
           ...
           : asset('assets/images/user-profile.jpeg')); ?>" alt="User Profile" />
             ...
             ring-1 ring-white dark:ring-gray-800 bg-green-500">
                                    ...
                                    <div class="truncate ltr:pl-4 rtl:pr-4">
                                        <h4 class="text-base">
                                            <?php echo e(Auth::user()->name ?? 'StarCode Kh'); ?>

                                        </h4>
                                        <a href="mailto:<?php echo e(Auth::user()->email ?? 'starcodekh@gmail.com'); ?>"
                                            class="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white">
                                            <?php echo e(Auth::user()->email ?? 'starcodekh@gmail.com'); ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('users.index')); ?>" class="dark:hover:text-white" @click="toggle">
...
<?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>