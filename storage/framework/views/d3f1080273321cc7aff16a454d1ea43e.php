...
<html lang="en" dir="ltr">
    <head>
        ...
        <style>
            @font-face {
                font-family: 'Dongrek';
                src: url('<?php echo e(asset('fonts/dongrek.ttf')); ?>') format('truetype');
                font-weight: normal;
                font-style: normal;
                font-display: swap;
            }
            ...
            @font-face {
                font-family: 'Dangrek';
                src: url('<?php echo e(asset('fonts/Dangrek/Dangrek-Regular.ttf')); ?>') format('truetype');
                font-weight: normal;
                font-style: normal;
            }

            .khmer-font {
                font-family: 'Dangrek', 'Battambang', 'Khmer OS', sans-serif;
            }
        </style>
    </head>
    <style>
...
<?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/layouts/app.blade.php ENDPATH**/ ?>