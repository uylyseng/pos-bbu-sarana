...
<div class="container">
    ...
    <!-- Header Section -->
    <div class="header">
        <img src="<?php echo e(asset('storage/' . $store->image)); ?>" alt="Store Logo" class="logo">
        <h2>Daily Sales Report</h2>
    </div>

    <!-- Date Range -->
    <p class="date-range">
        <strong >From:</strong> <?php echo e($startDate->format('F d, Y')); ?> &nbsp;
        <strong>To:</strong> <?php echo e($endDate->format('F d, Y')); ?>
    ...
    <table>
        ...
        <tfoot>
            <tr>
                ...
                <td><?php echo e($dailySales->sum('total_quantity')); ?></td>
                <td>$<?php echo e(number_format($dailySales->sum('total_sales'), 2)); ?></td>
            </tr>
        </tfoot>
    </table>
...
<div class="no-print" style="text-align: center; margin-top: 20px;">
    <a href="<?php echo e(route('reports.daily-sales')); ?>" class="btn" style="margin-right: 15px;">Back</a>
...
<?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/reports/print_dailysale.blade.php ENDPATH**/ ?>