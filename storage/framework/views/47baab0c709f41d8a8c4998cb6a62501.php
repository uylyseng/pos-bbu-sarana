    ...
    <div class="container">
            ...
            <div class="mb-6 grid grid-cols-1 gap-6 text-white sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                    ...
                    <div class="mt-5 flex items-center font-semibold">
                        ...
                        <span>Last Month: $<?php echo e(number_format($totalSales, 2)); ?></span>
                    </div>
                </div>
        ...
        <div class="flex justify-between items-center">
            ...
            <div x-data="{ open: false }" @click.outside="open = false" class="relative">
                ...
                <ul x-cloak x-show="open" x-transition class="absolute right-0 mt-2 w-32 bg-white shadow-lg rounded-md text-black">
                    <li><a href="<?php echo e(route('reports.topsellingproduct')); ?>" class="block px-4 py-2 hover:bg-gray-100">View Report</a></li>
        ...
        <div class="mt-5 flex items-center">
            <div class="text-3xl font-bold text-white mr-3">
                <?php echo e($mostSoldProduct->product_name ?? 'No product'); ?>

            </div>
            <div class="badge bg-white/30 px-3 py-1 text-white rounded-full">
                <?php echo e($mostSoldProduct->total_quantity ?? 0); ?> sold
            </div>
        </div>
        ...
        <div class="mt-5 flex items-center font-semibold text-white">
            ...
            <span>Last Week: <?php echo e($mostSoldProduct->last_week_sold ?? 0); ?></span>
        </div>
    </div> -->
                    ...
                    <div class="flex justify-between">
                        ...
                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                            ...
                            <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms=""
                                ...
                                <li><a href="<?php echo e(route('reports.topsellingproduct')); ?>" @click="toggle">View Report</a></li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/dashboard/sale.blade.php ENDPATH**/ ?>