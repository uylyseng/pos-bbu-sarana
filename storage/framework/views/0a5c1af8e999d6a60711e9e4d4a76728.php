...
<div class="container mx-auto px-4 py-6">
    ...
    <nav aria-label="breadcrumb" class="mb-4 flex justify-start">
        <ol class="flex text-gray-500 font-semibold dark:text-white">
            <li>
                <a href="<?php echo e(route('home')); ?>" class="hover:text-gray-500/70 dark:hover:text-white/70">
                    <?php echo e(__("Home")); ?>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td class="align-middle px-4 py-2">
                        <?php if($store->image): ?>
                        <img
                            src="<?php echo e(asset('storage/' . $store->image)); ?>"
                            alt="Store Image"
                            class="store-img">
                        <?php else: ?>
                        <img
                            src="<?php echo e(asset('assets/images/nophoto.png')); ?>"
                            alt="Store Image"
                            class="store-img">
                        <?php endif; ?>
                    </td>
                    <td class="align-middle px-4 py-2"><?php echo e($store->name); ?></td>
                    <td class="align-middle px-4 py-2"><?php echo e($store->contact); ?></td>
                    <td class="align-middle px-4 py-2"><?php echo e($store->address); ?></td>
                    <td class="align-middle px-4 py-2 text-center">
                        <button class="inline-flex items-center px-3 py-1 mr-2 border border-blue-500 text-blue-500 rounded hover:text-blue-700 hover:border-blue-700" onclick="openEditModal(<?php echo e(json_encode($store)); ?>)">
                            <i class="fa-solid fa-pen-to-square mr-1" style="color: blue;"></i> Edit
                        </button>
                        <button class="inline-flex items-center px-3 py-1 border border-red-500 text-red-500 rounded hover:text-red-700 hover:border-red-700" onclick="confirmDelete('<?php echo e(route('stores.destroy', $store->id)); ?>')">
...
<script>
    function openCreateModal() {
        ...
        document.getElementById('storeForm').action = "<?php echo e(route('stores.store')); ?>";
    ...
    function openEditModal(store) {
        ...
        if (store.image) {
            document.getElementById('imagePreview').src = `<?php echo e(asset('storage')); ?>/${store.image}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lyseng/pos-bbu-sarana/resources/views/stores/index.blade.php ENDPATH**/ ?>