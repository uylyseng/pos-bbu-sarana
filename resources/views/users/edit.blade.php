    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card shadow-lg p-4 bg-white dark:bg-gray-900 rounded-lg">
                ...
                <!-- Edit User Form -->
                <form class="space-y-5" action="{{ route('users.update', $getRecord->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name', $getRecord->name) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email', $getRecord->email) }}"
                                    class="form-input w-full px-3 py-2 border rounded-md dark:bg-gray-800 dark:text-white dark:border-gray-700"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="roles_id" name="roles_id"
                                        class="form-input w-full px-3 py-2 border rounded-md dark:bg-gray-800 dark:text-white dark:border-gray-700">
                                        <option value="" {{ old('roles_id', $getRecord->roles_id) ? '' : 'selected' }} disabled>Select Role</option>
                                        @foreach ($getRole as $role)
                                            <option value="{{ $role->id }}" {{ old('roles_id', $getRecord->roles_id) == $role->id ? 'selected' : '' }}>
                                                {{ ucfirst($role->name) }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="gender" name="gender"
                                        class="form-input w-full px-3 py-2 border rounded-md dark:bg-gray-800 dark:text-white dark:border-gray-700">
                                        <option value="" {{ old('gender', $getRecord->gender) ? '' : 'selected' }} disabled>Select Gender</option>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="status" value="active" id="statusSwitch"
                                        ...
                                        {{ old('status', $getRecord->status) == 'active' ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <img id="imagePreview" src="{{ $getRecord->profile ? asset('storage/' . $getRecord->profile) : asset('assets/images/default-user.png') }}"
