...
<div class="container mx-auto px-4 py-6">
        ...
        <table class="w-full whitespace-nowrap shadow-sm">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                    ...
                    <td class="px-4 py-2">{{ $table->group ? $table->group->name : 'No Group' }}</td>
                    <td class="px-4 py-2 text-center">
                        <button class="text-blue-500 hover:text-blue-700 px-3 py-1 border border-blue-500 rounded mr-2" onclick="openEditModal({{ json_encode($table) }})">
                            <i class="fa-solid fa-pen-to-square"  style="color: blue;"></i> Edit
                        </button>
                        <button class="text-red-500 hover:text-red-700 px-3 py-1 border border-red-500 rounded" onclick="confirmDelete('{{ route('tables.destroy', $table->id) }}')">
    ...
    @if ( $tables->total() > 0)
<div >
    {{ $tables->links('layouts.pagination') }}
</div>
@else
